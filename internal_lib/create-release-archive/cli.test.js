...
describe('create-release-archive/cli', () => {
  ...
  it('parses command line arguments', () => {
    ...
    createReleaseArchiveSync.mockImplementation(() => 'qux.foo')
    cli.cli()

    expect(createReleaseArchiveSync).toHaveBeenCalledWith(expect.objectContaining({
  ...
  it('prints an error and exits if it does not recognise the arguments', () => {
    ...
    expect(createReleaseArchiveSync).not.toHaveBeenCalled()
